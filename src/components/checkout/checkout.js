...
const Checkout = () => {
    ...
    const fetchFee = async () => {
      try {
        ...
        const appointmentType =
          localStorage.getItem("appointmentType") || "clinic";
  ...
  const handleOthersPayment = async () => {
    try {
      ...
      const patientMobileNumber = localStorage.getItem("mobileNumber");
  ...
  const triggerPaymentGateway = async (paymentSessionId) => {
    try {
      ...
      await cashfree.checkout({
        ...
        returnUrl:
          "https://advanceclinic.niramayahomoeopathy.com/components/paymentconfirmation",
          // "http://localhost:3000/components/paymentconfirmation",
      });
  ...
  const handleUPIPayment = async (upiId) => {
    try {
      ...
      const currency = localStorage.getItem("currency") || "INR";
      const patientName = localStorage.getItem("patientName") || "Unknown";
      const patientMobileNumber = localStorage.getItem("patientMobileNumber");
      const patientId = localStorage.getItem("patientId");
          ...
          <div style={{ textAlign: "center", marginTop: "20px" }}>
            <button
              ...
              style={{
                padding: "12px 24px",
                borderRadius: "5px",
                backgroundColor: isChecked ? "#0091A5" : "#ccc",
                color: "white",
                border: "none",
                fontSize: "16px",
                fontWeight: "bold",
