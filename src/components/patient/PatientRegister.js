...
//       history.push('/patient/login'); // Navigate to PatientLogin page
//     } catch (error) {
...
//               <p style={{ fontSize: 'large' }}>Doctor Register <Link to="/doctor/register">Click here</Link></p>
//             </div>
...
//             <p style={{ fontSize: 'large' }}>Already have an account? <Link to="/patient/login">Login</Link></p>
...
//     e.preventDefault();
//     try {
//       const response = await BaseUrl.get(`/patient/patientregister/?mobile_number=${mobileNumber}&password=${password}`);
//       if (response.status === 200) {
