                        ...
                        {isLoggedIn && (
                            <li className={`nav-item dropdown ${dropdownOpen ? 'show' : ''}`}>
                                ...
                                <div className={`dropdown-menu dropdown-menu-right ${dropdownOpen ? 'show' : ''}`} aria-labelledby="navbarDropdown">
                                    <Link className="dropdown-item" to="/patient/details" onClick={toggleDropdown}>My Details</Link>
                                    <Link className="dropdown-item" to="/patient/slots" onClick={toggleDropdown}>My Appointments</Link>
                                    <Link className="dropdown-item" to="/patient/bookappointment" onClick={toggleDropdown}>Book Appointments</Link>
                                    <Link className="dropdown-item" to="/patient/medicalrecords" onClick={toggleDropdown}>Medical Record</Link>
                                </div>
                            </li>
                        )}
                    </ul>
