...
//                       cursor: "pointer",
//                     }}
//                     onClick={() => setSelectedFile({ type: "video", url: report.url })}
...
//       <Row className="text-center mt-4">
//         <Col>
//           <h5 style={{ fontWeight: "700", fontSize: "16px" }}>Total Slots</h5>
...
//       <Modal show={!!selectedFile} onHide={() => setSelectedFile(null)} centered size="lg">
//   <Modal.Header closeButton>
//     <Modal.Title>
                      ...
                      if (type === "image") {
                        ...
                        return (
                          <video
                            ...
                            //   if (!e.target.paused) {
                            //     e.target.pause();
                            //     e.target.currentTime = 0; // Resetting the time is optional. If you don't want it, remove this line.
                            //   }
                            // }}
                          >
                            <source src={report.url} type="video/mp4" />
