  ...
  const handleRemoveSymptom = async (symptom) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setErrorMessageSymptom(errorMessageSymptom);
      }
    } catch (error) {
      const errorMessageSymptom =
