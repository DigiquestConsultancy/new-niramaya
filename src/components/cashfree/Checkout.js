  ...
  const handlePayment = async (e) => {
    ...
    try {
      const response = await fetch(
        // "http://192.168.29.95:8000/payment/create/",
        "http://192.168.29.95:8000/payment/create/",
        {
          method: "POST",
          headers: {
      ...
      if (data.paymentSessionId) {
        const checkoutOptions = {
          paymentSessionId:
            "session_JyPOs78nbwbBd_I1tSJ--9T50DPimv38w8BUBnsLnM6LUu3Xg42q9FjgREtsEyeC4Ihh0ZECD4TFzhHEa0TkgQkl1UiLHhn5zpuakcMMDzug",
