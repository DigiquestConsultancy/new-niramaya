...
const PatientAppointmentBooks = () => {
    ...
    const fetchDoctorName = async (receptionId) => {
        ...
        try {
            const response = await BaseUrl.get(`/reception/doctordetailsbyreceptionid/?reception_id=${receptionId}`);
        ...
        <div className="container mt-5">
            <div style={{ backgroundColor: '#f5f5f5', padding: '20px', borderRadius: '8px' }}>
                ...
                <div className="d-flex justify-content-between align-items-center">
                    <h2 style={{ paddingBottom: '32px', fontWeight: '600' }}>
                        Book Appointment
                    </h2>
                ...
                <div className="mt-4">
                    <h3 style={{ textAlign: 'center', margin: '32px', fontWeight: '600' }}>Select Slot</h3>
