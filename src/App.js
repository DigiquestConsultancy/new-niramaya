...
// import ManageTemplates from "./components/doctor/ManageTemplates";
...
//             <ProtectedRoute exact path="/doctor/home" component={DoctorHome} />
//             <ProtectedRoute
//               exact
...
// Static Pages
import StaticHome from "./components/static-pages/HomePage";
      ...
      <div className="app-container">
        ...
        <main className="app-content">
          <Switch>
            ...
            <Route
              exact
              path="/components/paymentconfirmation"
              component={Paymentconfiramation}
            />
            <Route exact path="/finddoctor" component={FindDoctor} />
            <Route exact path="/consult" component={Consult} />
            <Route exact path="/medicine" component={Medicine} />
            ...
            <Route
              exact
              path="/Conditions/tearmandcondition"
